        ...
        <svg width="0" height="0" aria-hidden="true" className="absolute">
          <defs>
            <clipPath id="clip-arch" clipPathUnits="objectBoundingBox">
              <path d="M 0 0.4 C 0 0.1790625 0.223828125 0 0.5 0 C 0.776171875 0 1 0.1790625 1 0.4 V 1 H 0 Z" />
            </clipPath>
          </defs>
        </svg>
        {children}
      ...
      <div className="mx-auto grid max-w-7xl gap-12 px-5 py-16 sm:px-8 md:grid-cols-4">
        <div>
          ...
          <p className="mt-5 max-w-xs text-sm text-muted-foreground">
            Arquitetura e design de interiores 100% remoto. Atendimento para todo o mundo, de
            Blumenau ao seu endereço.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="mt-3 text-xs text-muted-foreground">Seg–Sex · 9h às 18h</p>
        </div>
      </div>
